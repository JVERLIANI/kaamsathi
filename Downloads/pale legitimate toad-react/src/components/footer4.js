        ...
        <div className="footer4-content">
          ...
          <div className="footer4-links">
            ...
            >
              {props.link1 ?? (
                <Fragment>
                  <span className="footer4-text18">Home</span>
                </Fragment>
              )}
            </a>
            <a
        ...
        <div className="footer4-credits">
          ...
          <div className="footer4-row">
            <div className="footer4-container">
              <span className="thq-body-small">© 2025 KaamSathi</span>
            </div>
            <div className="footer4-footer-links">
              ...
              <span className="thq-body-small">
                {props.termsLink ?? (
                  <Fragment>
                    <span className="footer4-text14">Terms and Conditions</span>
                  </Fragment>
                )}
              </span>
              <span className="thq-body-small">
