        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            <a href={props.link2Url} className="thq-body-small thq-link">
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar8-text14">Post a Job</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar8-text20">Dashboard</span>
                </Fragment>
              )}
            </a>
            <div
            ...
            >
              <span className="thq-body-small thq-link">
                {props.link4 ?? (
                  <Fragment>
                    <span className="navbar8-text16">Sign In</span>
                  </Fragment>
                )}
              </span>
                      ...
                      <div className="navbar8-menu-item4">
                        ...
                        <div className="navbar8-content4">
                          <span className="navbar8-page41 thq-body-large">
                            {props.page4 ?? (
                              <Fragment>
                                <span className="navbar8-text26">Sign In</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                ...
                <div className="navbar8-menu-item6">
                  ...
                  <div className="navbar8-content6">
                    <span className="navbar8-page22 thq-body-large">
                      {props.page2 ?? (
                        <Fragment>
                          <span className="navbar8-text25">Post a Job</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
                ...
                <div className="navbar8-menu-item7">
                  ...
                  <div className="navbar8-content7">
                    <span className="navbar8-page32 thq-body-large">
                      {props.page3 ?? (
                        <Fragment>
                          <span className="navbar8-text22">Dashboard</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
...
Navbar8.defaultProps = {
  ...
  page3ImageSrc:
    'https://images.unsplash.com/photo-1667893639515-28cb963f10b8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNzMyNjg1Nnw&ixlib=rb-4.0.3&q=80&w=1080',
  ...
  page2ImageAlt: 'Job Posting Form Image',
  page3: undefined,
  logoSrc:
    'https://aheioqhobo.cloudimg.io/v7/_playground-bucket-v2.teleporthq.io_/84ec08e8-34e9-42c7-9445-d2806d156403/fac575ac-7a41-484f-b7ac-875042de11f8?org_if_sml=1&force_format=original',
  page3ImageAlt: 'Dashboard Image',
  action2: undefined,
  page4ImageAlt: 'Sign In Image',
  page4ImageSrc:
    'https://images.unsplash.com/photo-1620920015693-980524203ad5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNzMyNjg1NXw&ixlib=rb-4.0.3&q=80&w=1080',
  ...
  page4: undefined,
  page2ImageSrc:
    'https://images.unsplash.com/photo-1653669486884-48b9938fe446?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNzMyNjg1Nnw&ixlib=rb-4.0.3&q=80&w=1080',
  linkUrlPage3: 'https://www.teleporthq.io',
  page1ImageSrc:
    'https://images.unsplash.com/photo-1667893570304-1c0b1a71d10b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNzMyNjg1NXw&ixlib=rb-4.0.3&q=80&w=1080',
  page1: undefined,
}
